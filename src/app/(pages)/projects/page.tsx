    ...
    <main className={styles.main}>
      <section className={styles.container} aria-labelledby="projects-title">
        <div className={styles.header}>
          ...
          <div className={styles.headerActions}>
            ...
            <Button href="/contact" buttonStyle="secondary" className="hoverArrow">
              Snakk med oss
              <ArrowUpRight size={18} aria-hidden="true" className={`${styles.arrowUpIcon} $"arrowIcon"`} />
            </Button>
          </div>
        </div>
        ...
        <aside className={styles.systemCard} aria-label="Om prosjektarkivet">
          <div className={styles.systemTopline}>
            ...
            <span className={styles.liveStatus}>Aktiv</span>
          </div>
          <dl>
            <div>
              <dt>Fagområder</dt>
          ...
          <p>
            Ett prosjekt kan kobles til flere tjenestepunkter på tvers av
            fagområdene. Mediestrukturen støtter både vanlige bilder og
            før-/etter-par.
          </p>
        </aside>
      </section>
      ...
      >
        <div className={styles.catalogIntro}>
          <p className={styles.eyebrow}>Alle områder</p>
          <h2>Finn arbeid etter tjeneste.</h2>
          <p>
            Tjenestelenkene tar deg direkte til riktig punkt. Tomme plasser er
            ferdig rigget for to til tre prosjekter per tjeneste, og
            tverrfaglige prosjekter vises automatisk under alle relevante
            punkter.
          </p>
        </div>
        <ProjectGallery />
